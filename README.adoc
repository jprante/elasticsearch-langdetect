...
[source]
----
./bin/elasticsearch-plugin install http://xbib.org/repository/org/xbib/elasticsearch/plugin/elasticsearch-langdetect/5.4.0.1/elasticsearch-langdetect-5.4.0.1-plugin.zip
----
